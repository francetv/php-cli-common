...
class GitServiceTest extends \PHPUnit_Framework_TestCase
{
    public function testConstruct()
    {
        ...
        $this->assertEquals('Ftven\\Build\\Common\\Extension\\Core\\Service\\Git\\GitService', get_class($s));
    }
    public function testGetUser()
    {
        ...
        $systemMock = $this->getMock(
            'Ftven\\Build\\Common\\Extension\\Core\\Service\\System\\SystemService', ['execute'], [], '', false
        );
